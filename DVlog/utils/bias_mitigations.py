...
def setup_mixfeat_subgroup(self, annotations_df: pd.DataFrame, seed: int=42) -> pd.DataFrame:
...
def setup_mixfeat_mixedgender(self, annotations_df: pd.DataFrame, seed: int=42) -> pd.DataFrame:
        """Setup the mixfeat features following the 'Fairness for a Small Dataset of Multi-modal Dyadic Mental Well-being Coaching' paper.
